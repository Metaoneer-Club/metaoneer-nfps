      ...
      <div className="max-w-[1200px] mx-auto pt-10 pb-40">
        <div className="flex items-center rounded border border-gray-200 dark:border-dark-300 bg-white dark:bg-dark">
          ...
          <div className="text-sm pl-10 flex items-center">
            ...
            >
              <option value={0}>투표중</option>
              <option value={1}>참여율</option>
            </select>
          </div>
          <div className="text-sm pl-10 flex items-center">
            ...
            <select
              ...
              value={detailFilter}
              className="bg-[length:20px_20px] w-32 bg-no-repeat bg-[center_right_12px] bg-[url('/media/icons/dropdown.svg')] appearance-none text-sm border border-gray-400 rounded px-6 py-2"
            >
...
const filterItems = [
  {
    label: "상태",
    option: ["전체", "찬성 우세", "반대 우세"],
  },
  {
    label: "비율",
    option: ["전체", "0% ~ 50%", "50% ~ 75%", "75% ~ 100%"],
  },
];
